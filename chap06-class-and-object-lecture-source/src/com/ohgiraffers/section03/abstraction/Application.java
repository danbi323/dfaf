...
public class Application {
    public static void main(String[] args) {
        ...
        // 객체를 설계하기 위해선 복잡한 현실 세계를 그대로 반영하기에는 너무 방대하고 복잡하기에
//        현실세계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법을 적용

        /*
        추상화란?
        공통된 부분을 추출하고 공통되지 않은 부분을 제거. 추상화 목적은 유연성은
        확보하기위함. 유연성확보는 여러곳에 적용가능한 유일한 객체를 의미, 즉 재사용성이높음
    ...
    1. 필요한 객체 도출
     - 사용자, 카레이서, 자동차
     2. 객체간의 상호작용
     - 카레이서가 수신할수있는 메시지(카레이서가 해야하는일)
     1. 시동을 걸어라
     2. 엑셀을 밟아라
     3. 브레이크를 밟아라
     4. 시동을 꺼라
     - 자동차가 수신할 수 잇는 메세지(자동차가 할 일)
     1. 시동을 걸어라
     2. 앞으로 가라
     3. 멈춰라
     4. 시동 꺼라
